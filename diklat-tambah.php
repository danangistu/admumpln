<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Tambah Diklat Pegawai <small>input data diklat pegawai</small></h1>
	<!-- end page-header -->
				...
				<div class="panel-body">
						...
						<div id="wizard">
									...
									<div class="row">
												...
												<select id="kode_diklat" name="kode_diklat" class="default-select2 form-control" data-parsley-group="wizard-step-1" required>
													...
													<?php
														...
														foreach($rows as $row){
															...
															echo "<option value='$kode'>$kode | $judul</option>";
														}
													?>
												</select>
											</div>
										...
										<div class="col-md-9">
											<div class="form-group col-md-4">
												...
												<input type="date" id="tgl_selesai" name="tgl_selesai" class="form-control" data-parsley-group="wizard-step-1" required />
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group col-md-12">
										...
										<div class="col-md-12">
											<div class="form-group col-md-5">
												...
												<input type="text" id="bidang_diklat" name="bidang_diklat" placeholder="Bidang Diklat" class="form-control" />
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group block1 col-md-2">
												<label>Nilai</label>
												<input type="number" id="nilai" name="nilai" placeholder="Input Nilai" class="form-control" data-parsley-type="number" data-parsley-maxlength="3" data-parsley-max="100" data-parsley-group="wizard-step-1" />
											</div>
										</div>
									</div>
									<!-- end row -->
							...
							<div>
								<div class="jumbotron m-b-0 text-center">
									...
									<p><button class="btn btn-success btn-lg" type="submit" name="diklattambah" value="Simpan">Simpan</button></p>
								</div>
							</div>
							<!-- end wizard step-4 -->
						</div>
					...
					<div id="success">
						...
						<div class="col-md-12">
							...
							<div class="col-md-4">
								<a href="/admumpln/diklat" class="btn btn-lg btn-block btn-inverse"><span class="fa fa-arrow-left"></span> Kembali ke Diklat Pegawai</a>
							</div>
						</div>
					</div>
					<?php
					...
					<div id="gagal">
						...
						<div class="col-md-12">
							<div class="col-md-4">
								<a href="/admumpln/diklat/tambah/<?php echo $kode ?>" class="btn btn-lg btn-block btn-info"><span class="fa fa-plus"></span> Input Data Kembali</a>
							</div>
							<div class="col-md-4">
								<a href="/admumpln/diklat" class="btn btn-lg btn-block btn-inverse"><span class="fa fa-arrow-left"></span> Kembali ke Diklat Pegawai</a>
							</div>
